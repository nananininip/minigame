...
<body>
    ...
    <div class="container menu-container">
        ...
        <div class="menu-buttons">
            <button class="menu-btn" onclick="location.href='../quiz/quiz_instruction.html'">🧠 ควิซ</button>
            <button class="menu-btn" onclick="location.href='../game/waste_instruction.html'">🗑️ เกมแยกขยะ</button>
            <button class="menu-btn" onclick="location.href='../leaderboard/leaderboard.php'">🏆 อันดับผู้เล่น</button>
            <button class="menu-btn" onclick="location.href='../feedback/feedback.html'">📊 แบบสอบถาม</button>
        </div>
