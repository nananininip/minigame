...
<body>
    <div class="header-box">
        <a href="../utils/index.php" class="brand" aria-label="Mini Game Home">
            <img class="brand-logo" src="../assets/logo/HT.jpg" alt="Hi-Trust Logo">
    ...
    <div class="mascot-row">
        <img src="../assets/mascots/mascot-leaf.png" alt="Leaf Mascot" class="mascot mascot-leaf">
    </div>
</body>
